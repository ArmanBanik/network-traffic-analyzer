...
if not PYSHARK_AVAILABLE:
    st.warning("⚠️ Packet analysis is disabled on cloud (tshark not available). Run locally for full functionality.")
...
if uploaded_files:
    ...
    if not PYSHARK_AVAILABLE:
        st.error("❌ Packet analysis not supported on cloud (tshark missing). Please run locally.")
        st.stop()
